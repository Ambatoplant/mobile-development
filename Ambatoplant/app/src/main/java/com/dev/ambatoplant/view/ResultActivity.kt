...
import com.dev.ambatoplant.databinding.ActivityResultBinding
import com.dev.ambatoplant.view.adapter.NewsAdapter
...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val resultData = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            intent.getParcelableExtra(EXTRA_CLASSIFICATION_RESULT, HistoryEntity::class.java) // Pastikan HistoryEntity yang diterima
        } else {
            @Suppress("DEPRECATION")
            intent.getParcelableExtra(EXTRA_CLASSIFICATION_RESULT) // Versi lama
        }
